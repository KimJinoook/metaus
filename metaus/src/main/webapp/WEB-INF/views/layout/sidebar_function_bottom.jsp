...
<script src="${pageContext.request.contextPath}/js/custom_mypage.js"></script>
...
<script src="${pageContext.request.contextPath}/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
<!-- iCheck -->
...
<!-- progressSchedule -->
<script src='${pageContext.request.contextPath}/js/progressSchedule.js'></script>
<!-- compose -->
<script src="${pageContext.request.contextPath}/js/compose.js" type="text/javascript"></script>
<!-- mailbox -->
<script src="${pageContext.request.contextPath}/js/mailbox.js" type="text/javascript"></script>